...
├── 4Deriverable.pdf                --> Documento di specifiche del progetto (Parte 4)
├── TrentoUnica_pitch.pdf           --> Presentazione del pitch del progetto
├── Descrizione_progetto.pdf        --> Documento di presentazione del progetto
